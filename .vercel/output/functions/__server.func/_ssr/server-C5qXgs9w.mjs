...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-C5qXgs9w.js
var server_C5qXgs9w_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BiPiNzpL.mjs");
...
//#endregion
export { createServerEntry, server_default as default, createCsrfMiddleware as n, createMiddleware as r, server_C5qXgs9w_exports as t };
