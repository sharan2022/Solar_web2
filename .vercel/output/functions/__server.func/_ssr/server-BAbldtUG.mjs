...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-BAbldtUG.js
var server_BAbldtUG_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Dr8BK4TM.mjs");
...
//#endregion
export { createServerEntry, server_default as default, createCsrfMiddleware as n, createMiddleware as r, server_BAbldtUG_exports as t };
